...
<div class="relative h-[700px] overflow-auto px-6"
data-te-spy="scroll"
...
data-te-offset="200">
    ...
    {#each products as product, id}
      <div class={`mb-16 flex flex-wrap ${id % 2 === 0 ? '' : 'lg:flex-row-reverse'}`}>
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
          <div
            ...
            <img src={product.image} class="w-full" alt="Louvre" />
            <a href={`/article/${urlSlug(product.title)}`} use:link>
              <div
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">  
            <h3 class="mb-4 text-2xl font-bold">{product.title}</h3>
            ...
            <p class="mb-6 text-sm text-neutral-500 dark:text-neutral-400">
              Published <u>{product.publishDate}</u> by
